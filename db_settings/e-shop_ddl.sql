...
CREATE TABLE `TB_TOKEN` (
    `TOKEN_NO`	BIGINT	NOT NULL    AUTO_INCREMENT  PRIMARY KEY COMMENT '토큰번호',
    `USER_TYPE`	CHAR(2)	NOT NULL    COMMENT '유저타입',
    `USER_NO`	BIGINT	NOT NULL    COMMENT '유저번호',
    `LINKED_TOKEN_NO`	BIGINT	NULL    COMMENT '연관토큰번호',
    `TOKEN`	VARCHAR(55) NOT NULL    COMMENT '랜덤토큰',
    `EXPIRE_DT`	DATETIME	NOT NULL    COMMENT '만료일시',
    `REG_DT`	DATETIME	NOT NULL    DEFAULT NOW()   COMMENT '등록일시',
    `UPD_DT`	DATETIME	NOT NULL    DEFAULT NOW()   COMMENT '수정일시'
);

CREATE TABLE `TB_TOKEN2` (
    `TOKEN_NO`	BIGINT	NOT NULL    AUTO_INCREMENT  PRIMARY KEY COMMENT '토큰번호',
    `USER_TYPE`	CHAR(2)	NOT NULL    COMMENT '유저타입',
    `USER_NO`	BIGINT	NOT NULL    COMMENT '유저번호',
    `GROUP_NO`	BIGINT	NOT NULL    COMMENT '토큰 그룹번호',
    `TYPE`	VARCHAR(10)	NOT NULL    COMMENT '토큰타입',
    `TOKEN`	VARCHAR(55)	NOT NULL    COMMENT '랜덤토큰',
    `EXPIRE_DT`	DATETIME	NOT NULL    COMMENT '만료일시',
    `REG_DT`	DATETIME	NOT NULL    DEFAULT NOW()   COMMENT '등록일시',
    `UPD_DT`	DATETIME	NOT NULL    DEFAULT NOW()   COMMENT '수정일시'
...
CREATE TABLE `TB_TOKEN3` (
    `TOKEN_NO`	BIGINT	NOT NULL    AUTO_INCREMENT  PRIMARY KEY COMMENT '토큰번호',
    `USER_TYPE`	CHAR(2)	NOT NULL    COMMENT '유저타입',
    `USER_NO`	BIGINT	NOT NULL    COMMENT '유저번호',
    `RANDOM_ACCESS_TOKEN`	VARCHAR(50)	NOT NULL    COMMENT '엑세스 토큰 랜덤토큰',
    `ACCESS_EXPIRE_DT`	DATETIME	NOT NULL    COMMENT '엑세스 토큰 만료일시',
    `RANDOM_REFRESH_TOKEN`	VARCHAR(55)	NOT NULL    COMMENT '리프레시 토큰 랜덤토큰',
    `REFRESH_EXPIRE_DT`	DATETIME	NOT NULL    COMMENT '리프레시 토큰 만료일시',
    `REG_DT`	DATETIME	NOT NULL    DEFAULT NOW()   COMMENT '등록일시',
    `UPD_DT`	DATETIME	NOT NULL    DEFAULT NOW()   COMMENT '수정일시'
);
