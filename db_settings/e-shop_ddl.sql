...
CREATE TABLE `TB_BASKET` (
	`TRANS_NO`	BIGINT	NOT NULL	COMMENT '장바구니 내역 식별번호',
...
CREATE TABLE `TB_EPAY` (
	`TRANS_NO`	BIGINT	NOT NULL	COMMENT '거래번호',
	`USER_NO`	BIGINT	NOT NULL	COMMENT '유저번호',
	`ORDER_NO`	BIGINT	NOT NULL	COMMENT '주문번호',
...
CREATE TABLE `TB_ISSUE_COUPON` (
	`TRANS_NO`	BIGINT	NOT NULL	COMMENT '쿠폰발급 내역 식별번호',
	`COUPON_NO`	BIGINT	NOT NULL	COMMENT '쿠폰번호',
	`USER_NO`	BIGINT	NOT NULL	COMMENT '유저번호',
	`STATUS`	CHAR(2)	NOT NULL	COMMENT '상태코드',
...
CREATE TABLE `TB_CATEGORY` (
	`CATEGORY_NO`	BIGINT	NOT NULL	COMMENT '카테고리 식별번호',
...
ALTER TABLE `TB_ORDER_ITEM` ADD CONSTRAINT `PK_TB_ORDER_ITEM` PRIMARY KEY (
	`ORDER_ITEM_NO`
);
...
ALTER TABLE `TB_EPAY` ADD CONSTRAINT `PK_TB_EPAY` PRIMARY KEY (
	`TRANS_NO`
);

ALTER TABLE `TB_ISSUE_COUPON` ADD CONSTRAINT `PK_TB_ISSUE_COUPON` PRIMARY KEY (
	`TRANS_NO`
);
